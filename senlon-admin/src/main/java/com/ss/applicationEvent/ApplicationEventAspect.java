package com.ss.applicationEvent;
...
public class ApplicationEventAspect {
	...
	@Pointcut("execution(* com.ss.web.controller.system.SysLoginController.ajaxLogin(..))")
	public void afterLoginPointcut() {
	}

	/*@Pointcut("execution(* com.ss.quartz.controller.SysJobController.run(..))")
