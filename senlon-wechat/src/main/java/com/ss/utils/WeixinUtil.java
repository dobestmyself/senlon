...
import com.ss.common.factory.MySSLProtocolSocketFactory;
...
public class WeixinUtil {
    ...
    public static JSONObject httpRequest(String requestUrl, String requestMethod, String outputStr) {
        ...
        try {
            ...
            //设置网络超时
            httpUrlConn.setConnectTimeout(600000);
    ...
    public static JSONObject sendMediaByUrl(String fileType, String url, String token) {
        ...
        //    String valuename = System.currentTimeMillis() + suffix;
    ...
    /**
     ...
     public static byte[] getBytes(String filePath) {
         filePath = Global.getProfile() + filePath.substring(filePath.lastIndexOf("/profile")+8);
